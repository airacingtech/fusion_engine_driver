...
public:
  ...
  static fusion_engine_msgs::msg::Pose populate(
    const point_one::fusion_engine::messages::PoseMessage & contents)
  {
    ...
    msg.latitude = contents.lla_deg[0]; msg.longitude = contents.lla_deg[1];
    msg.altitude = contents.lla_deg[2];
    ...
    msg.velocity_flu.x = contents.velocity_body_mps[0];
    msg.velocity_flu.y = contents.velocity_body_mps[1];
    msg.velocity_flu.z = contents.velocity_body_mps[2];
    msg.velocity_flu_covariance[0] = contents.velocity_std_body_mps[0] *
      contents.velocity_std_body_mps[0];
    msg.velocity_flu_covariance[4] = contents.velocity_std_body_mps[1] *
      contents.velocity_std_body_mps[1];
    msg.velocity_flu_covariance[8] = contents.velocity_std_body_mps[2] *
  ...
  static fusion_engine_msgs::msg::PoseAux populate(
    const point_one::fusion_engine::messages::PoseAuxMessage & contents)
  {
    ...
    msg.velocity_enu_covariance[0] = contents.velocity_std_enu_mps[0] *
      contents.velocity_std_enu_mps[0];
    msg.velocity_enu_covariance[4] = contents.velocity_std_enu_mps[1] *
      contents.velocity_std_enu_mps[1];
    msg.velocity_enu_covariance[8] = contents.velocity_std_enu_mps[2] *
      contents.velocity_std_enu_mps[2];

    msg.position_body_covariance[0] = contents.position_std_body_m[0] *
      contents.position_std_body_m[0];
    msg.position_body_covariance[4] = contents.position_std_body_m[1] *
      contents.position_std_body_m[1];
    msg.position_body_covariance[8] = contents.position_std_body_m[2] *
      contents.position_std_body_m[2];
...
// GNSS Info
  static fusion_engine_msgs::msg::GnssInfo populate(
    const point_one::fusion_engine::messages::GNSSInfoMessage & contents)
  {
    ...
    msg.corrections_age = contents.corrections_age;
    msg.baseline_distance = contents.baseline_distance;
...
// GNSS Satellite Info
  static fusion_engine_msgs::msg::GnssSatelliteInfo populate(
    const point_one::fusion_engine::messages::SatelliteInfo & sat)
  {
  ...
  static fusion_engine_msgs::msg::GnssSatellite populate(
    const point_one::fusion_engine::messages::GNSSSatelliteMessage & contents)
  {
...
// Calibration Status
  static fusion_engine_msgs::msg::CalibrationStatus populate(
    const point_one::fusion_engine::messages::CalibrationStatusMessage & contents)
  {
    ...
    msg.rpy_mounting.roll = contents.ypr_deg[2]; msg.rpy_mounting.pitch = contents.ypr_deg[1];
    msg.rpy_mounting.yaw = contents.ypr_deg[0];
    ...
    msg.rpy_max_covariance[2] = contents.mounting_angle_max_std_dev_deg[2] *
      contents.mounting_angle_max_std_dev_deg[2];
    msg.rpy_max_covariance[1] = contents.mounting_angle_max_std_dev_deg[1] *
      contents.mounting_angle_max_std_dev_deg[1];
    msg.rpy_max_covariance[0] = contents.mounting_angle_max_std_dev_deg[0] *
      contents.mounting_angle_max_std_dev_deg[0];
...
// Relative ENU Position
  static fusion_engine_msgs::msg::RelativeEnuPosition populate(
    const point_one::fusion_engine::messages::RelativeENUPositionMessage & contents)
  {
  ...
  static sensor_msgs::msg::Imu populate(
  ...
  static fusion_engine_msgs::msg::GnssAttitudeOutput populate(
    const point_one::fusion_engine::messages::GNSSAttitudeOutput & contents)
  {
    ...
    msg.baseline_distance_covariance = contents.baseline_distance_std_m *
      contents.baseline_distance_std_m;

    return msg;
  }

  static fusion_engine_msgs::msg::WheelSpeedOutput populate(
    const point_one::fusion_engine::messages::WheelSpeedOutput & contents)
  {
  ...
  static fusion_engine_msgs::msg::VehicleSpeedOutput populate(
    const point_one::fusion_engine::messages::VehicleSpeedOutput & contents)
  {
  ...
  /* Raw Utils */
  static sensor_msgs::msg::Imu populate(
    const point_one::fusion_engine::messages::RawIMUOutput & contents)
  {
    sensor_msgs::msg::Imu msg;
  ...
  static fusion_engine_msgs::msg::RawGnssAttitudeOutput populate(
    const point_one::fusion_engine::messages::RawGNSSAttitudeOutput & contents)
  {
    fusion_engine_msgs::msg::RawGnssAttitudeOutput msg;
    msg.solution_type = static_cast<int>(contents.solution_type);

    msg.baseline.x = contents.relative_position_enu_m[0];
    msg.baseline.y = contents.relative_position_enu_m[1];
    msg.baseline.z = contents.relative_position_enu_m[2];
    msg.baseline_covariance.x = contents.position_std_enu_m[0];
    msg.baseline_covariance.y = contents.position_std_enu_m[1];
    msg.baseline_covariance.z = contents.position_std_enu_m[2];
    return msg;
  }

  static fusion_engine_msgs::msg::RawWheelSpeedOutput populate(
    const point_one::fusion_engine::messages::RawWheelSpeedOutput & contents)
  {
  ...
  static fusion_engine_msgs::msg::RawVehicleSpeedOutput populate(
    const point_one::fusion_engine::messages::RawVehicleSpeedOutput & contents)
  {
  ...
  static fusion_engine_msgs::msg::RawWheelTickOutput populate(
    const point_one::fusion_engine::messages::RawWheelTickOutput & contents)
  {
  ...
  static fusion_engine_msgs::msg::RawVehicleTickOutput populate(
    const point_one::fusion_engine::messages::RawVehicleTickOutput & contents)
  {
  ...
  /***********************************************************************************************************/
  /* ROS Utils */
  static geometry_msgs::msg::PoseStamped populate(
    const point_one::fusion_engine::messages::ros::PoseMessage & contents)
  {
    geometry_msgs::msg::PoseStamped msg;
    msg.pose.position.x = contents.position_rel_m[0];
    msg.pose.position.y = contents.position_rel_m[1];
    msg.pose.position.z = contents.position_rel_m[2];
    msg.pose.orientation.x = contents.orientation[0];
    msg.pose.orientation.y = contents.orientation[1];
    msg.pose.orientation.z = contents.orientation[2];
    msg.pose.orientation.w = contents.orientation[3];
    return msg;
  }

  static gps_msgs::msg::GPSFix populate(
    const point_one::fusion_engine::messages::ros::GPSFixMessage & contents)
  {
    ...
    msg.pitch = contents.pitch_deg;       msg.roll = contents.roll_deg;
    msg.dip = contents.dip_deg;

    msg.time = contents.p1_time.seconds;

    msg.gdop = contents.gdop;           msg.pdop = contents.pdop;
    msg.hdop = contents.hdop;
    msg.vdop = contents.vdop;           msg.tdop = contents.tdop;

    msg.err = contents.err_3d_m;       msg.err_horz = contents.err_horiz_m;
    msg.err_vert = contents.err_vert_m;
    msg.err_track = contents.err_track_deg;  msg.err_speed = contents.err_speed_mps;
    msg.err_climb = contents.err_climb_mps;
    msg.err_pitch = contents.err_pitch_deg;  msg.err_roll = contents.err_roll_deg;
    msg.err_dip = contents.err_dip_deg;
    msg.err_time = contents.err_time_sec;
    std::copy(
      std::begin(contents.position_covariance_m2), std::end(contents.position_covariance_m2),
    ...
    const point_one::fusion_engine::messages::ros::IMUMessage & contents)
  {
    ...
    std::copy(
      std::begin(contents.orientation_covariance), std::end(contents.orientation_covariance),
      std::begin(msg.orientation_covariance));

    std::copy(
      std::begin(contents.angular_velocity_covariance),
      std::end(contents.angular_velocity_covariance),
      std::begin(msg.angular_velocity_covariance));

    std::copy(
      std::begin(contents.acceleration_covariance), std::end(contents.acceleration_covariance),
   ...
   */
  static std::string nmeaDegToDdmm(
    double angle_deg,
...
/***********************************************************************************************************/
/**
 * @brief Print a block of data in hexadecimal format to the ROS2 logger.
 *
 * @param logger The ROS2 logger to use for printing.
 * @param data Pointer to the block of data to be printed.
 * @param size Size of the data block in bytes.
 * @param label A label to prefix the printed data for context.
 */

static inline void dumpHex(rclcpp::Logger logger, const uint8_t* data, size_t size, const std::string& label) {
    std::ostringstream oss;
    oss << label << " (" << size << " bytes):\n";
